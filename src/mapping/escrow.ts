...
import { Escrow, Transaction } from "../generated/schema"
...
export function handleStoreResults(call: StoreResultsCall): void {
  let id = call.transaction.hash
  let transaction = new Transaction(id)
  transaction.save()
}

export function handleBulkPayOut(call: BulkPayOutCall): void {
  let id = call.transaction.hash
  let transaction = new Transaction(id)
  transaction.save()
}
